...
class PersonnageManager {
    ...
    public function add(Personnage $perso) {
        ...
        // Assignation des valeurs pour le nom, la force, les dégâts, l'espérience et le niveau du personnage.
    ...
    public function get($id) {
        ...
        // Exécute une requête de type SELECT avec une clause WHERE, et retourne un objet Personnages.
